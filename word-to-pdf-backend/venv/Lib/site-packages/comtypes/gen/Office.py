...
from comtypes.gen._2DF8D04C_5BFA_101B_BDE5_00AA0044DE52_0_2_8 import (
    xlLineMarkersStacked, sigdetColorDepth, msoTextEffect40, Library,
    msoBulletKanjiKoreanPeriod, msoTextureCork,
    msoUnderlineDoubleLine, msoCameraOrthographicFront,
    msoLanguageIDSerbianLatin, xlCircle, msoTextEffectMixed,
    msoShapeFlowchartPunchedTape, xlXYScatterSmooth, msoPlaceholder,
    UserPermission, msoShapeFoldedCorner, msoBalloonButtonAbort,
    ...
    msoFillSolid, msoLanguageIDSpanishEcuador, msoFillMixed,
    msoShapeMathPlus, xlPyramidColStacked100, xlDataLabelsShowPercent,
    msoGraphicStylePreset13, xlCategoryLabelLevelCustom,
    msoElementChartTitleNone, msoComboLabel, TabStops2, xlPieOfPie,
    msoLanguageIDCroatian, msoSortByLastModified, msoShapePieWedge,
    msoCameraIsometricOffAxis3Bottom, xlLineStacked,
    msoContactCardTypePersonalDistributionList, msoConditionIsYes,
    msoElementDataLabelTop, ICommandBarComboBoxEvents,
    MsoDebugOptions_UTRunResult, msoTextureLeft, BroadcastStarted,
    msoCalloutAngleAutomatic, msoPatternDownwardDiagonal,
    msoReflectionTypeNone, xlVAlignBottom,
    msoEncodingISO2022JPNoHalfwidthKatakana, xl3DColumn, IMsoWalls,
    msoControlOLEUsageServer, msoEncodingIA5Norwegian,
    xlThousandMillions, msoExtrusionColorAutomatic, msoEncodingBaltic,
    msoShapeFlowchartDelay, msoConditionFreeText,
    xlComboColumnClusteredLine, msoEncodingISO2022JPJISX02011989,
    msoLanguageIDArabicKuwait, msoShapeDodecagon, msoViewSummaryInfo,
    msoThemeAccent5, msoLanguageIDDutch, msoEncodingOEMUnitedStates,
    ...
    IUnknown, msoMaterialPowder, msoFileTypeCalendarItem,
    msoBlogOneCategory, msoFileDialogViewDetails, msoGradientBrass,
    SmartArtColor, msoWizardActInactive, msoConditionIncludesFormsOf,
    msoEncodingJapaneseShiftJIS, GroupShapes, msoTextureCanvas,
    msoLineStylePreset3, msoButtonSetBackNextSnooze,
    msoLanguageIDSpanishUruguay, msoBulletAlphaLCPeriod,
    msoThemeColorText1, msoTabStopMixed,
    msoFilterComparisonLessThanEqual, msoCameraLegacyObliqueRight,
    ...
    msoShapeQuadArrow, xlValueNone, msoEncodingKorean, msoControlEdit,
    msoExtrusionColorCustom, msoLightRigMorning,
    msoTextEffectShapeCascadeDown, certverresValid,
    msoAlertButtonAbortRetryIgnore, msoShapeIsoscelesTriangle,
    msoEncodingISO88591Latin1, msoNoUnderline,
    msoEffectMosiaicBubbles, OfficeDataSourceObject, xlPieExploded,
    msoElementSecondaryCategoryAxisTitleHorizontal, msoBevelCross,
    msoAnimationThinking, ReflectionFormat, msoBulletThaiAlphaPeriod,
    msoTextEffectShapeArchDownCurve, msoDateTimehmmAMPM,
    msoColorTypeMixed, xlTreemap, ODSOColumns, xlBarStacked, xlFloor,
    msoSyncErrorVirusUpload, msoShapeMathNotEqual,
    msoShapeCurvedDownArrow, msoTextEffect2, msoLanguageIDMalaysian,
    msoLanguageIDRomanian, msoElementDataTableNone, IMsoDownBars,
    msoElementPlotAreaShow, msoSegmentLine, msoShapeCurvedLeftArrow,
    msoShapeStylePreset4, msoDateTimeMMMMyy, msoEffectPencilSketch,
    CanvasShapes, msoLanguageIDFrenchLuxembourg, msoLanguageIDMixed,
    msoGradientTwoColors, msoElementSecondaryValueGridLinesNone,
    msoElementPrimaryValueAxisShow, msoLineStylePreset10,
    msoEffectPaintStrokes, msoShapeStylePreset25, msoBlackWhiteWhite,
    _CustomTaskPane, msoScreenSize800x600, msoTextEffect8,
    msoEncodingThai, msoShapeMoon, msoTextEffectShapeButtonPour,
    msoStrictCharWrap, xlChartTitle, msoExtrusionLeft,
    msoLanguageIDBurmese, msoLightRigBrightRoom, CustomXMLNodes,
    IMsoFloor, msoShapeStylePreset55, msoWizardMsgSuspending,
    msoLanguageIDArabicJordan, xlPlotArea, msoWarpFormat35,
    msoLinked3DModel, msoFilterConjunctionOr, msoBulletNone,
    msoShadow27, msoSignatureSubsetSignatureLinesSigned,
    msoLanguageIDDivehi, msoConditionFileTypeOfficeFiles,
    msoPatternDashedDownwardDiagonal, _CommandBarComboBoxEvents,
    msoAlertCancelSecond, IDispatch, msoEncodingArabic,
    xlSplitByPosition, msoElementSeriesAxisGridLinesMinor,
    msoSyncAvailableAnywhere, IFind, msoViewFileInfo,
    msoCameraLegacyPerspectiveFront, msoShapeRoundedRectangle,
    xlSeriesNameLevelCustom, xlHistogram, xlValueDescending,
    msoCharacterSetThai, sigdetDelSuggSignerEmailSet,
    msoShapeStylePreset37, msoControlPopup, msoThreeD7, msoSendToBack,
    msoPropertyTypeFloat, msoLineStylePreset29, msoAlertCancelFirst,
    msoTextureOak, xlBubbleEx, msoLanguageIDFrenchMorocco,
    msoBarNoChangeDock, msoBalloonButtonNext,
    msoElementSeriesAxisNone, msoLanguageIDArabicAlgeria,
    msoTextEffectShapeDeflateBottom, msoLightRigLegacyFlat1,
    msoLightRigBalanced, IMsoDispCagNotifySink,
    msoConditionFileTypePhotoDrawFiles, msoGradientPeacock,
    ...
    msoEncodingISO88599Turkish, msoElementSecondaryValueAxisShow,
    msoElementPrimaryValueAxisTitleVertical,
    msoCameraLegacyObliqueTopRight, msoMetaPropertyTypeText,
    msoCameraObliqueTopRight, msoLanguageIDSwahili, msoPictureTypeBMP,
    msoLanguageIDGeorgian, msoLanguageIDSpanishDominicanRepublic,
    msoOrgChartLayoutLeftHanging, xlMillions, xlBottom,
    msoSyncVersionLastViewed, xlTransparent, msoBalloonButtonOptions,
    msoPermissionChange, offPropertyTypeFloat,
    CustomXMLValidationErrors, msoAnimationLookRight,
    ...
    msoShapeStylePreset71, msoElementChartTitleCenteredOverlay,
    ...
    msoLineDashStyleMixed, msoTextureWalnut, msoDisconnectedState,
    SharedWorkspaceLinks, msoScreenSize1600x1200, xlAreaStacked,
    msoShadowStyleInnerShadow, msoEncodingOEMArabic,
    msoEncodingOEMBaltic, TextFrame, xlSeries, xlConeColStacked100,
    msoSyncErrorFileNotFound, xlConeBarClustered, msoMergeCombine,
    ...
    xlCorners, IMsoBorder, msoWarpFormat31, msoShapeLeftRightRibbon,
    msoTextEffectShapeInflate, msoLanguageIDUzbekCyrillic,
    msoArrowheadWidthMedium, encprovdetCipherMode,
    xlMarkerStyleDiamond, msoMetaPropertyTypeMultiChoiceLookup,
    msoLanguageIDByelorussian, msoTextEffect26, xlDataLabelsShowNone,
    xlBarClusteredEx, msoTextEffectShapeFadeLeft, xlThousands,
    msoCameraLegacyObliqueBottomRight, msoConnectorCurve,
    sigdetShouldShowViewWarning, msoOrgChartLayoutDefault, xlCombo,
    ThemeFont, SmartArtLayout, msoSyncStatusError,
    msoLightRigLegacyHarsh4, xlOpaque,
    ...
    msoPatternDashedHorizontal, GlowFormat, msoLanguageIDManipuri,
    msoScaleFromTopLeft, msoShapeParallelogram,
    msoGraphicStylePreset11, msoTextureBrownMarble,
    msoAnimationLookUp, msoControlExpandingGrid,
    msoAnimationLookUpRight, msoShapeStylePreset50,
    msoShapeSnip1Rectangle, msoLanguageIDArabicBahrain,
    offPropertyTypeDate, xlConeColStacked, msoConditionIsExactly,
    SoftEdgeFormat, mfHTML, msoLanguageIDChineseSingapore,
    msoMaterialClear, msoCameraLegacyObliqueFront,
    msoLightingBottomRight, msoPatternDarkUpwardDiagonal,
    msoLanguageIDSesotho, msoThreeD4, xlGray25, msoSmartArtNodeAbove,
    msoShapeStylePreset16, msoShapeRectangle, msoBevelCoolSlant,
    msoLineSysDash, msoLanguageIDGalician, msoWarpFormat33,
    msoPatternDiagonalBrick, msoLineCapSquare, msoIntegerMixed,
    xlLegendPositionCorner, msoArrowheadTriangle,
    msoTextEffectShapeDeflateTop, msoFeatureInstallNone,
    msoAlertCancelFourth, msoGradientMultiColor, msoBarTypePopup,
    msoLineStylePreset27, msoEffectLightScreen,
    msoMetaPropertyTypeBusinessData, msoSyncErrorCouldNotUpdate,
    ODSOColumn, msoEncodingTurkish, msoAlignCenter, xlCrissCross,
    msoThemeAccent1, msoBevelArtDeco, msoDocInspectorStatusDocOk,
    msoElementLineSeriesLine, msoLanguageIDAfrikaans,
    msoPictureTypeGIF, msoListbyName, msoBulletHindiAlphaPeriod,
    TextEffectFormat, msoWarpFormat4, msoLanguageIDIndonesian,
    xlLightVertical, BroadcastCapSupportsUpdateDoc, LabelInfo,
    ...
    msoPatternSmallCheckerBoard, msoEncodingEBCDICHebrew, msoThreeD8,
    msoShapeStylePreset11, CustomXMLPrefixMappings,
    xlPivotChartExpandEntireFieldButton,
    msoTextEffectAlignmentStretchJustify, msoGradientChrome,
    IMsoLegend, msoAnimationGestureRight, msoEditingSmooth,
    msoUnderlineDotDotDashHeavyLine, msoAlertCancelThird,
    msoModeAutoDown, msoTextureBlueTissuePaper, msoLineFillSolid,
    msoConditionFileTypeTaskItem, msoTextureFishFossil,
    msoBackgroundStylePreset10, WorkflowTemplate, xl3DColumnClustered,
    msoGraphicStylePreset12, xlTickMarkOutside, IMsoChartTitle,
    msoConditionInTheLast, msoShapeBlockArc, msoLanguageIDSwissGerman,
    xlLegendEntry, xlSplitByCustomSplit, msoLanguageIDTswana,
    msoTextEffect10, msoLightRigSoft,
    msoElementPrimaryCategoryAxisShow, msoShadow9, msoAlertIconInfo,
    msoGraphicStylePreset23, msoFileTypePublisherFiles,
    msoElementChartTitleAboveChart, msoLanguageIDFulfulde, msoShadow8,
    msoBalloonButtonSnooze, msoWarpFormat28, msoFormControl,
    msoElementSecondaryCategoryAxisReverse,
    msoBulletKanjiSimpChinDBPeriod, msoShadow12, msoArrowheadOpen,
    _CustomXMLPartsEvents, xlInnerCounterClockwisePoint,
    msoLanguageIDSerbianBosniaHerzegovinaCyrillic, FileTypes,
    msoAnchorBottom, msoCameraLegacyPerspectiveTop, xlDistributed,
    xlBinsTypeBinCount, msoSegmentCurve, msoAutomationSecurityByUI,
    msoEncodingMacIcelandic, msoTextEffect29, msoUnderlineDashLine,
    msoEncodingISCIIPunjabi, msoLineFillNone, xlLegendPositionCustom,
    msoArrowheadLengthMixed, msoSyncStatusSuspended,
    msoElementPrimaryCategoryAxisTitleHorizontal,
    msoAlertButtonOKCancel, xlMinusValues, msoLanguageIDArmenian,
    xlSizeIsWidth, msoShapeCloud, msoShapeActionButtonHome,
    msoLineStylePreset38, msoFileTypeTaskItem,
    msoMetaPropertyTypeCalculated, msoTextureGranite,
    msoShapeLeftArrowCallout, msoShapeRoundedRectangularCallout,
    msoFileTypeExcelWorkbooks, msoContactCardFull,
    msoPresetGradientMixed, msoBackgroundStylePreset4,
    msoLanguageIDRussian, msoPicture, xlErrorBarTypeStDev,
    msoLineJoinMiter, msoTexturePaperBag, msoListbyTitle,
    msoPatternSolidDiamond, xlLineStacked100, msoCTPDockPositionTop,
    msoMetaPropertyTypeBusinessDataSecondary, msoShapeDownArrow,
    PickerProperties, msoCameraObliqueRight, ODSOFilter,
    msoConditionFileTypeWordDocuments, msoThreeD20,
    msoEncodingEBCDICDenmarkNorway, msoFillBackground, PRIVILEGED,
    msoAlertDefaultFifth, msoAnchorTopBaseline,
    msoSharedWorkspaceTaskStatusInProgress, msoBackgroundStylePreset6,
    Balloon, msoSmallCaps, msoAlertButtonYesNo, Crop,
    xlMarkerStyleAutomatic, IMsoUpBars, msoThemeColorAccent3,
    msoTextEffect12, msoAlertDefaultFirst, msoShapeCan,
    msoPictureCompressFalse, msoExtrusionTopLeft,
    msoCustomXMLNodeAttribute, xlMarkerStylePlus,
    msoTextEffectShapeStop, msoEncodingMacUkraine, msoLightingLeft,
    ...
    msoThemeColorDark2, msoShapeStylePreset49, IBlogExtensibility,
    msoShapeNonIsoscelesTrapezoid, msoConditionOnOrBefore,
    msoShapeFrame, msoDateTimeMdyy, xlRadarAxisLabels, xlMaximum,
    msoSyncStatusNoSharedWorkspace, msoButtonDown,
    ...
    msoShadow24, SharedWorkspaceFile, msoGraphicStylePreset25,
    msoEncodingEBCDICTurkishLatin5, msoPatternDottedGrid,
    msoAnchorCenter, xlInterpolated, msoConditionFileTypeWebPages,
    msoLanguageIDNoProofing, msoConditionYesterday, PropertyTests,
    ...
    msoGraphicStylePreset19, PickerFields, msoBulletCircleNumDBPlain,
    xlInnerCenterPoint, xlHundredThousands, msoShadow13,
    msoEncodingEBCDICInternational,
    msoLanguageIDMalayBruneiDarussalam, msoPatternUpwardDiagonal,
    msoElementSecondaryValueAxisBillions, xlPercent, msoBeforeNode,
    msoMenuAnimationSlide, msoLanguageIDSwissFrench,
    msoLanguageIDFrenchCanadian, msoCameraIsometricOffAxis4Right,
    msoPatternVertical, xlBox, msoControlOLEUsageBoth,
    LanguageSettings, msoWarpFormat3, msoShapeUpDownArrow,
    msoBarRowFirst, msoLineStylePreset37, msoLineStylePreset32,
    msoFontAlignMixed, msoGradientFromTitle, msoOrientationMixed,
    msoLineStylePreset16, msoShapeCircularArrow,
    msoPatternWideUpwardDiagonal, msoLanguageIDLithuanian,
    msoPatternDarkVertical, msoLanguageIDHausa, msoShapeBentUpArrow,
    FileSearch, msoEncodingIA5IRV, SignatureInfo, msoConditionToday,
    msoElementSecondaryCategoryGridLinesMinor,
    msoBackgroundStylePreset12, _check_version, msoTextEffect24,
    certverresUntrusted, msoTextOrientationMixed,
    msoEncodingOEMIcelandic, msoElementPrimaryCategoryAxisBillions,
    msoReflectionType6, msoTable, msoLightRigLegacyNormal2,
    msoButtonSetSearchClose, msoTextEffectShapeFadeDown,
    msoLightRigLegacyNormal1, xlStack, DataPrivacyOptions,
    msoMetaPropertyTypeNote, msoArrowheadNone, msoShapeStylePreset40,
    WorkflowTask, msoEncodingOEMCanadianFrench,
    msoScriptLanguageOther, sigtypeMax, msoPresetTextureMixed,
    msoChartFieldBubbleSize, xlAreaStacked100Ex, msoTextureTop,
    ...
    msoCameraPerspectiveRelaxedModerately, msoBulletSimpChinPeriod,
    xlVAlignTop, msoSyncStatusLocalChanges, sigdetApplicationVersion,
    ...
    msoConditionEqualsInProgress, msoCommandBarButtonHyperlinkOpen,
    msoLineStylePreset13, BroadcastPaused, msoLanguageIDExeMode,
    msoLanguageIDSerbianBosniaHerzegovinaLatin,
    msoLightRigLegacyFlat3, _CommandBarComboBox, msoStandardCharWrap,
    ...
    msoShapeStylePreset62, msoLanguageIDChineseMacao, PickerResult,
    msoLanguageIDArabicSyria, msoShadowMixed,
    msoControlSplitExpandingGrid,
    msoShapeLineCallout1BorderandAccentBar, msoLanguageIDLatvian,
    IConverter, msoMetaPropertyTypeUser, msoLineStylePreset34,
    xlGray8, DiagramNodeChildren, msoTextEffect35,
    msoLanguageIDBasque, msoLineStylePreset35, msoLanguageIDEnglishUS,
    ...
    msoOrgChartOrientationMixed, BackstageGroupStyleError,
    ...
    xlErrorBarTypeCustom, msoShape6pointStar, msoBevelRiblet, xlLTR,
    msoShapeFlowchartAlternateProcess, xlCombination,
    msoLanguageIDFrisianNetherlands, msoCameraIsometricRightUp,
    msoTelemetryConsentLevelFull, xlLegendKey,
    msoGraphicStylePreset21, msoTextureUserDefined,
    msoSignatureSubsetSignaturesAllSigs, xlMinorGridlines,
    msoBulletKanjiKoreanPlain, xlStar, msoLanguageIDAlbanian,
    msoPatternZigZag, msoShapeStylePreset14, Script, msoShapeHeptagon,
    msoPattern5Percent, msoSearchInMyNetworkPlaces, xlDataLabel,
    msoCustomXMLNodeText, msoFreeform, msoAnimationGestureLeft,
    msoPathType1, msoFontAlignCenter, msoShapeRegularPentagon,
    msoUnderlineWavyHeavyLine, msoMaterialSoftEdge, msoGradientDesert,
    xlRegionLabelOptionsShowAll, msoChartFieldFormula, xlTriangle,
    msoLanguageIDSwedishFinland, xlHAlignJustify,
    msoMetaPropertyTypeUrl, msoElementLegendRightOverlay,
    SharedWorkspaceLink, WebComponentProperties, IMsoLeaderLines,
    msoExtrusionColorTypeMixed, msoLastModifiedLastMonth,
    xlTickLabelPositionLow, msoLanguageIDQuechuaEcuador,
    msoPatternNarrowHorizontal, HTMLProject, xlHidden, IAccessible,
    ...
    msoExtrusionTopRight, sigdetSignatureType,
    msoEncodingEBCDICKoreanExtendedAndKorean, ICustomXMLPartsEvents,
    msoGradientFromCorner, msoShadowStyleMixed,
    ...
    msoSortOrderAscending, msoShapeLineCallout1AccentBar, xlNoCap,
    msoNotThemeColor, xlStockHLC, IMsoHyperlinks,
    msoEncodingEBCDICUSCanada, msoThemeColorAccent1,
    msoShape24pointStar, msoShapeFlowchartDecision,
    msoShapeStylePreset74, msoAutoSizeNone, msoThreeD14,
    msoLanguageIDZulu, xlVAlignCenter, xlUpBars, msoLineStylePreset9,
    msoFalse, msoLanguageIDSimplifiedChinese,
    msoEncodingISO88595Cyrillic, msoSingleStrike,
    msoEncodingISO88594Baltic, msoOrgChartLayoutMixed,
    msoElementSecondaryCategoryAxisTitleVertical,
    msoEncodingMacArabic, msoSyncErrorOutOfSpace,
    msoCameraIsometricOffAxis3Right, msoBackgroundStylePreset5,
    msoGraphicStyleMixed, msoElementSecondaryValueAxisLogScale,
    msoLanguageIDArabicUAE, msoFileTypeDataConnectionFiles,
    msoReflectionType2, msoEncodingISO88596Arabic,
    msoLineStylePreset33, msoAfterLastSibling, msoIconAlertWarning,
    msoScaleFromBottomRight, msoElementSeriesAxisReverse,
    xlMarkerStyleDash, msoWarpFormat32, IMsoChartGroup,
    msoConditionIncludesNearEachOther, LegendEntries,
    msoCTPDockPositionRestrictNoChange, msoAlertIconCritical,
    msoPathTypeMixed, msoAnimationGoodbye, msoAnimationEmptyTrash,
    sigprovdetUIOnly, msoUnderlineWavyDoubleLine,
    msoConditionLastMonth, sigdetDelSuggSigner, msoAlertDefaultSecond,
    msoDiagramMixed, msoLanguageIDEdo, xlCorner, msoBlackWhiteMixed,
    xlMarkerStyleNone, msoBulletRomanUCPeriod, xlDisplayUnitCustom,
    msoCameraObliqueTop, msoShapeStylePreset57, certverresError,
    ODSOFilters, msoSyncCompareSideBySide, certverresVerifying,
    msoCharacterSetSimplifiedChinese, msoTextEffectShapeSlantDown,
    msoTextureBouquet, msoBalloonButtonBack, msoBulletHebrewAlphaDash,
    msoMetaPropertyTypeMultiChoiceFillIn, msoAlignBottoms,
    xlGeoProjectionTypeAlbers, msoAnimationGetAttentionMajor,
    xlDisplayUnitNone, xlMarkerStyleTriangle,
    SensitivityLabelInitInfo, msoBulletArabicDBPlain,
    msoLanguageIDNorwegianBokmol, msoLanguageIDEnglishIndonesia,
    msoAnimationLookDownLeft, msoBarNoVerticalDock,
    msoPattern25Percent, msoGradientPresetColors, msoBarFloating,
    ...
    msoLanguageIDArabicOman, msoThreeD18, msoBaselineAlignFarEast50,
    PropertyTest, msoButtonUp, sigdetHorizResolution,
    msoElementDataLabelCallout, msoBalloonButtonIgnore,
    ICommandBarsEvents, msoGraphicStylePreset28,
    msoSyncErrorCouldNotCompare,
    msoCameraPerspectiveHeroicExtremeLeftFacing,
    msoShapeStylePreset41, mfPlainText, xlGray16, msoLightingRight,
    msoShape16pointStar, msoEncodingHebrew,
    msoBulletRomanUCParenRight, msoBackgroundStylePreset9,
    xlStockOHLC, msoContactCardAddressTypeSMTP, msoScreenSize720x512,
    sigprovdetUseOfficeStampUI, xlMarkerStyleCircle,
    msoAnimationBeginSpeaking, msoShapeStylePreset23,
    FileDialogFilters, msoShapeStylePreset51,
    msoLanguageIDSpanishParaguay, SmartArtNodes,
    msoShapeStylePreset64, certverresRevoked, msoShadow35,
    msoShapeRectangularCallout, msoShapeFlowchartMerge,
    msoShapeStylePreset22, msoShapeFlowchartPredefinedProcess,
    ...
    msoLanguageIDSomali, msoShapeStylePreset38, msoConditionNextMonth,
    msoShadow32, msoLanguageIDFrench, msoPatternDashedVertical,
    msoShapeLeftUpArrow, msoBarLeft, EffectParameter, msoMoveRowPrev,
    CommandBarControls, msoBulletHindiAlpha1Period, msoTextEffect22,
    ...
    xlSeriesNameLevelNone, msoBevelDivot, msoBulletHindiNumPeriod,
    xlMarkerStylePicture, msoLineCapMixed, msoPatternOutlinedDiamond,
    msoElementPrimaryCategoryAxisMillions, msoConditionNotEqualToHigh,
    msoConditionEqualsCompleted, msoWizardMsgLocalStateOff,
    WebPageFont, msoBlackWhiteBlackTextAndLine, msoLanguageIDUI,
    certverresUnverified, msoAlignJustify, sigdetWindowsVersion,
    msoBarNoMove, SmartArtQuickStyles, msoCameraIsometricTopDown,
    ThemeFonts, msoBackgroundStylePreset3, msoTrue,
    msoUnderlineHeavyLine, xlMarkerStyleX, msoFilterConjunctionAnd,
    Shape, msoLanguageIDFrenchZaire, IMsoTickLabels,
    msoGraphicStylePreset27, msoEncodingUTF8, DocumentInspectors,
    msoAnimationSearching, msoLightRigFlood,
    _CustomXMLSchemaCollection, msoLightRigTwoPoint,
    msoExtrusionBottomRight, msoDiagramCycle, xlLabelPositionAbove,
    msoOLEControlObject, msoBalloonErrorCOMFailure,
    msoShapeStylePreset58, xlParentDataLabelOptionsOverlapping, AUTO,
    ...
    msoCameraIsometricRightDown, xlStockVHLC, xlCap, xlWaterfall,
    msoElementSecondaryCategoryGridLinesMajor,
    msoElementSeriesAxisGridLinesMinorMajor, msoElementLineDropLine,
    msoShapeLineCallout3, dispid, msoGraphic,
    msoEncodingSimplifiedChineseGBK, msoEffectBrightnessContrast,
    ...
    msoCameraObliqueLeft, msoWizardMsgResuming, SharedWorkspaceMember,
    xlRowField, msoButtonIconAndWrapCaption, msoCalloutAngleMixed,
    msoElementSecondaryCategoryAxisThousands, msoOLEMenuGroupEdit,
    msoReflectionType7, msoShapeFlowchartCard, msoAlignRights, xlAxis,
    sigdetSignedData, msoPermissionPrint, _CustomXMLPart,
    msoEncodingEBCDICFinlandSweden, xlAutomatic,
    msoBlackWhiteInverseGrayScale, msoConditionNotEqualToCompleted,
    msoSyncErrorNone, msoShapeLineCallout4, msoConditionEquals,
    xlAutomaticScale, msoShapeStylePreset9, msoTriStateMixed,
    msoTextOrientationVerticalFarEast, PickerDialog, IMsoCharacters,
    xlVertical, msoGraphicStylePreset20, msoLanguageIDArabic,
    siglnimgUnsigned, xlPyramidColStacked, xl3DBarClustered,
    msoTextureStationery, msoTextEffect23, msoTexturePinkTissuePaper,
    msoPermissionRead, msoShapeExplosion1, msoElementErrorBarNone,
    xlShowLabelAndPercent, msoAnimationCharacterSuccessMajor,
    xlOtherCombinations, msoTextEffectAlignmentCentered,
    msoArrowheadDiamond, msoTextDirectionLeftToRight,
    msoBlogNoCategories, msoWarpFormatMixed, xlConeBarStacked100,
    msoCameraIsometricOffAxis1Left, msoCameraObliqueTopLeft,
    msoLanguageIDPashto, msoButtonCaption, ISensitivityLabel,
    msoLightRigContrasting, ICommandBarButtonEvents,
    msoBulletAlphaUCPeriod, msoShapeLeftBracket,
    msoLanguageIDChineseMacaoSAR, msoLanguageIDEnglishTrinidad,
    xlTickLabelOrientationAutomatic, Model3DFormat,
    msoLanguageIDFrenchReunion, msoCaseLower, msoBalloonButtonTips,
    msoShapeSwooshArrow, msoBackgroundStyleMixed, msoTargetBrowserV4,
    ...
    xlMillionMillions, xlWalls, msoSyncEventDownloadInitiated,
    xlHAlignDistributed, msoLineLongDash, msoTextureGreenMarble,
    msoThemeColorLight1, siglnimgSignedValid, CommandBarComboBox,
    msoShapeLineInverse, xlSeriesColorGradientStyleSequential,
    BackstageGroupStyleWarning, BackstageGroupStyleNormal, msoShadow2,
    xlPivotChartFieldButton, msoEncodingISO885915Latin9,
    msoCameraIsometricLeftDown, msoCalloutThree,
    xlGeoMappingLevelState, msoShadow36,
    msoSharedWorkspaceTaskStatusCompleted, msoCalloutDropCustom,
    msoPresetLightingDirectionMixed, msoEffectPastelsSmooth,
    msoElementTrendlineAddTwoPeriodMovingAverage, msoMaterialPlastic2,
    msoShapeStylePreset65, xlYears, msoShapeStylePreset72,
    msoLineStylePreset8, msoConditionIsNo, msoShadow6,
    ...
    msoGradientDaybreak, SharedWorkspace, xlLabelPositionInsideEnd,
    msoBalloonButtonCancel, xlSplitByPercentValue, IMsoChartData,
    msoLanguageIDGermanLuxembourg, msoTextEffect11, msoFillPatterned,
    xlGradientStopPositionTypePercent,
    msoButtonIconAndWrapCaptionBelow, PictureEffects,
    msoMaterialTranslucentPowder, msoConditionFileTypeAllFiles,
    msoEncodingKOI8R, msoBlackWhiteAutomatic, msoUnderlineDotDashLine,
    ...
    msoLanguageIDEnglishBelize, msoHyperlinkInlineShape, GradientStop,
    _lcid, msoControlSplitDropdown, msoTextEffectShapeChevronDown,
    msoEmbeddedOLEObject, msoThemeColorAccent4,
    msoElementPrimaryCategoryAxisTitleBelowAxis, msoLanguageIDHindi,
    xlSurfaceWireframe, msoAlertDefaultThird, msoShapeOval,
    xlUnderlineStyleDouble, msoShapeFlowchartDocument,
    msoButtonSetOkCancel, msoWarpFormat29, msoBottomSection,
    xlConeColClustered, msoTextureTopLeft, msoFileDialogOpen, xlZero,
    msoConditionAnytime, msoFilterComparisonContains,
    msoLanguageIDAmharic, msoElementSecondaryValueAxisTitleHorizontal,
    msoFileFindSortbyTitle, xlSquare, msoScriptLocationInHead,
    msoLineStylePreset14, VARIANT, CustomXMLPart, msoShapeOctagon,
    msoShapeLineCallout4NoBorder, msoLastModifiedThisMonth,
    msoShapeDonut, msoContactCardTypePersonalContact,
    msoLanguageIDBelgianDutch, xlRadarMarkers, msoBevelTypeMixed,
    SharedWorkspaceTask, xlRTL, msoScriptLanguageVisualBasic,
    msoCameraPerspectiveLeft, msoNoError, msoLineStylePreset19,
    xlCylinder, msoPatternCross, msoFileDialogSaveAs, xlCategory,
    ...
    msoElementTrendlineNone, encprovdetBlockCipher,
    msoFileTypeOfficeFiles, xl3DAreaStacked100,
    RibbonControlSizeLarge, xl3DPie, IMsoChartArea,
    msoTextEffectShapeCircleCurve, msoFileFindSortbyFileName,
    msoContactCardTypeUnknownContact, msoFileTypeOutlookItems,
    xlColorIndexAutomatic, SmartArtLayouts,
    msoCameraLegacyObliqueTopLeft, msoControlOLEUsageNeither,
    msoShapeStylePreset52, msoShadow1, msoEncodingUTF7,
    xlAxisCrossesCustom, msoTextEffect49, msoLanguageIDSyriac,
    msoSyncStatusConflict, msoCalloutAngle60,
    msoElementSecondaryValueAxisMillions, msoThreeD6,
    xlPivotChartDropZone, msoLastModifiedAnyTime,
    msoMetaPropertyTypeDateTime, msoSyncVersionServer, SmartDocument,
    xlChartY, msoExtrusionRight, xlAreaEx, contverresValid,
    msoLanguageIDHelp, msoLanguageIDKyrgyz, msoLineFillPatterned,
    msoShapeActionButtonHelp, TextColumn2, ILicAgent,
    msoTextEffectShapeCanUp, msoLanguageIDTsonga,
    ...
    _CommandBarActiveX, msoHTMLProjectStateDocumentProjectUnlocked,
    msoDistributeHorizontally, msoFileDialogFolderPicker,
    msoEffectGlass, msoMedia, HRESULT, msoButtonIconAndCaptionBelow,
    CustomXMLSchemaCollection, msoElementLegendLeftOverlay,
    msoThemeColorBackground1, xlYErrorBars, msoLanguageIDTibetan,
    msoMetaPropertyTypeBoolean, xlPivotChartCollapseEntireFieldButton,
    msoShapeWave, siglnimgSignedInvalid,
    ...
    msoScriptLocationInBody, msoLanguageIDFrenchSenegal, IFoundFiles,
    msoEncodingEBCDICLatinAmericaSpain, msoWizardActResume,
    xlNotPlotted, msoShapeMathMultiply, msoPictureGrayscale,
    msoShapeStylePreset63, msoTextEffect32, msoScreenSize1152x900,
    msoShapeStylePreset56, xlHundreds, xlDefaultAutoFormat,
    ...
    msoLightRigHarsh, msoButtonSetAbortRetryIgnore,
    ...
    msoConditionThisWeek, msoFontAlignTop, msoLightingTop,
    siglnimgSigned, ServerPolicy, msoFileTypeDesignerFiles, xlHigh,
    msoConditionAtLeast, msoBalloonButtonNull, msoTextureBottomRight,
    msoElementLegendBottom, msoHTMLProjectStateDocumentLocked,
    xlXYScatter, msoPatternNarrowVertical, certdetExpirationDate,
    msoAlignMixed, msoLanguageIDGermanAustria, msoTextEffect46,
    msoLightRigLegacyNormal3, msoCharacterSetCyrillic, msoShadow17,
    msoLanguageIDItalian, msoLanguageIDJapanese, msoShapeChartX,
    xlConeCol, MetaProperty, msoConditionFileTypeExcelWorkbooks,
    msoWarpFormat8, msoShapeRound1Rectangle, certverresExpired,
    ChartGroups, msoLineSolid, msoLanguageIDKashmiriDevanagari,
    msoEncodingEUCChineseSimplifiedChinese, msoLanguageIDCatalan,
    msoExtrusionBottomLeft, SignatureSet, msoLanguageIDHebrew,
    msoShapeRightBrace, msoShapeUTurnArrow, xlPyramidColClustered,
    ...
    msoCustomXMLValidationErrorSchemaGenerated, msoTextureBottom,
    msoEncodingOEMMultilingualLatinI, msoEncodingT61, msoTextEffect31,
    _IMsoOleAccDispObj, msoPatternPlaid, msoLineStylePreset20,
    xlScaleLogarithmic, msoCameraPerspectiveHeroicLeftFacing,
    xlConeToMax, xlPageField, msoShapeStylePreset10, msoSlicer,
    msoLanguageIDGujarati, msoEncodingOEMPortuguese, helpstring,
    msoLanguageIDKannada, msoButtonAutomatic,
    msoShapeActionButtonMovie, msoLineStylePreset25, xlLegend,
    xlPareto, xlOuterCounterClockwisePoint, msoBulletTradChinPeriod,
    xlLineStackedEx, msoElementSecondaryValueAxisTitleRotated,
    msoLanguageIDBelgianFrench, msoSyncEventOffline,
    msoHTMLProjectOpenSourceView, msoblogImageTypeJPEG, xlUpward,
    msoCameraIsometricBottomDown, msoCustomXMLNodeCData,
    msoElementDataTableShow, certdetAvailable, sigprovdetUrl,
    msoEncodingISO88597Greek, msoTextEffect13, msoMetaPropertyTypeMax,
    msoTextEffect28, msoLanguageIDDzongkhaBhutan, msoReflectionType9,
    msoShadow34, xlAreaStackedEx, xlDataLabelsShowLabelAndPercent,
    xlHorizontal, xlStretch, msoCharacterSetGreek, IMsoDiagram,
    ...
    xlSeriesLines, msoButtonSetNone, msoEncodingISO88593Latin3,
    PictureEffect, msoFileTypeBinders, msoFontAlignAuto,
    ...
    msoEditingSymmetric, msoLastModifiedThisWeek, msoNoStrike,
    ...
    msoTextureNewsprint, xlHorizontalCoordinate, msoConditionEndsWith,
    msoLanguageIDArabicTunisia, msoLightRigGlow,
    msoUnderlineSingleLine, msoGradientEarlySunset,
    msoConditionBeginsWith, msoShapeLineCallout4BorderandAccentBar,
    ...
    xlXYScatterEx, msoTextEffectShapeCurveUp, msoGradientNightfall,
    msoContactCardTypeEnterpriseContact, sigprovdetHashAlgorithm,
    msoTextEffectShapeWave2, msoButtonSetBackClose,
    msoLastModifiedLastWeek, msoShadow16, msoLinkedPicture,
    msoPatternLargeConfetti, msoEncodingISCIIBengali,
    msoShapeStylePreset47, xlHAlignFill,
    msoTextEffectShapeDeflateInflate, msoSmartArtNodeDefault,
    msoTexturePreset, msoShapeTypeMixed, SharedWorkspaceFolders,
    msoIconNone, msoElementSecondaryCategoryGridLinesNone,
    ...
    msoShapeBevel, msoAutomationSecurityLow, msoDistributeVertically,
    msoEncodingGreek, msoShapeLineCallout2, msoShadow10,
    xlCategoryScale, msoLineStylePreset41, GridLines, FoundFiles,
    msoPatternHorizontal, mso3DModel, xlValue, msoShapeStylePreset7,
    msoThemeAccent6, msoTextEffect5, msoTabAlignLeft,
    msoMetaPropertyTypeGuid, msoShapeChord, msoLightingDim,
    msoLightRigThreePoint, msoSharedWorkspaceTaskPriorityHigh,
    msoTextureCenter, msoTextEffectAlignmentLetterJustify,
    msoTextEffectShapeRingOutside, msoEncodingUSASCII,
    msoElementPrimaryCategoryAxisTitleRotated, msoNewfromExistingFile,
    msoMoveRowFirst, msoConditionNextWeek, msoTargetBrowserV3,
    xlShowPercent, msoBlackWhiteLightGrayScale, xlOuterCenterPoint,
    ...
    msoTextEffectShapeWave1, msoPatternDottedDiamond, msoGradientMoss,
    msoShapeFlowchartOfflineStorage, xlDoughnutEx, OfficeTheme,
    msoGradientRainbowII, msoEditingAuto, msoUnderlineDotDotDashLine,
    msoShapeLineCallout3BorderandAccentBar, msoWarpFormat12,
    msoLanguageIDMaori, msoFileTypeTemplates, msoShapeStylePreset19,
    msoMetaPropertyTypeChoice, msoSyncErrorVirusDownload,
    msoFontAlignBottom, msoElementPrimaryCategoryAxisLogScale,
    msoGradientGoldII, xlMarkerStyleStar,
    msoEncodingSimplifiedChineseGB18030, msoLineStylePreset36,
    xlSemiGray75, msoElementLegendRight, msoOLEMenuGroupNone,
    msoShapeSnipRoundRectangle, msoLightRigSunset,
    msoSmartArtNodeAfter, msoWarpFormat9, msoSortOrderDescending,
    msoTextEffect20, ShapeRange, msoAlignLeft, msoThreeD13,
    msoLanguageIDSwedish, _CommandBarsEvents,
    msoCameraPerspectiveBelow, msoShapeStylePreset48,
    msoConditionAnyNumberBetween, msoGradientOcean,
    msoLanguageIDHungarian, xlLegendPositionTop,
    msoConditionInTheNext, xlPower, msoPictureCompressTrue,
    xlHundredMillions, msoFileFindSortbySize, msoThemeDark2,
    msoEncodingArabicAutoDetect, msoTextureDenim,
    msoOLEMenuGroupWindow, IMsoEnvelopeVBEvents, msoTextEffect33,
    msoShapeStylePreset73, msoSyncCompareAndMerge,
    msoEffectPlasticWrap, msoCameraIsometricOffAxis2Left,
    msoShapeMathMinus, msoButtonTextBelow, msoTextEffect47,
    msoTextEffect9, xlBinsTypeCategorical, msoVerticalAnchorMixed,
    ...
    msoLanguageIDFrenchCongoDRC, ICustomXMLPartEvents,
    msoFileDialogViewTiles, msoShapeFlowchartMagneticDisk,
    msoSyncConflictServerWins, msoTabStopLeft, xlSunburst,
    msoCameraPerspectiveRelaxed, msoLanguageIDFaeroese,
    msoEffectMarker, msoElementPrimaryCategoryGridLinesNone,
    msoCTPDockPositionFloating, msoControlCustom, MsoDebugOptions_UT,
    msoChartFieldRange, msoEncodingMacHebrew, msoGradientOneColor,
    ...
    msoEncodingEBCDICRussian, msoShapeDownRibbon, msoAlertIconWarning,
    msoScreenSize1152x882, FreeformBuilder, msoLanguageIDYoruba,
    msoMetaPropertyTypeLookup, msoGradientMixed, xlAbove,
    msoBackgroundStyleNotAPreset, xlColumnStacked100,
    msoShapeStylePreset35, msoShapeStylePreset76, msoShapeHalfFrame,
    msoLanguageIDTurkmen, msoGraphicStylePreset3, msoShapeBalloon,
    msoIodGroupVSTOR35Mgd, msoShapeNotPrimitive, NOT_SET,
    msoChartFieldCategoryName, RulerLevel2, msoPictureTypeDefault,
    xlCylinderColStacked, msoDiagramAssistant, xlTrendline,
    SearchFolders, xlBinsTypeAutomatic, msoEncodingISCIIAssamese,
    msoThreeD19, xlColumnClusteredEx, Signature,
    msoShapeStylePreset53, msoLanguageIDQuechuaBolivia,
    msoShapeFlowchartData, msoShadow7, msoSortBySize, msoEffectBlur,
    msoBringInFrontOfText, msoDocInspectorStatusError,
    msoBalloonButtonOK, msoShapeRightArrowCallout, xlBinsTypeManual,
    CoClass, msoTextEffectShapeDeflate, msoThemeColorHyperlink,
    msoSharedWorkspaceTaskStatusDeferred, msoControlGraphicCombo,
    msoElementSecondaryCategoryAxisTitleAdjacentToAxis, IAssistance,
    xlXErrorBars, msoChart, xlJustify, msoConditionFileTypeNoteItem,
    msoCameraPerspectiveRight, msoShapeStylePreset5, xl3DBarStacked,
    RulerLevels2, msoConditionIsNot, xlLabelPositionMixed,
    HTMLProjectItem, msoExtrusionNone, LineFormat,
    msoSyncConflictMerge, msoFilterComparisonNotEqual,
    msoColorTypeInk, msoLanguageIDTurkish, msoShapeStylePreset60,
    msoSyncErrorUnknownUpload, msoContentApp,
    msoEncodingSimplifiedChineseAutoDetect, msoWarpFormat37,
    msoShapeRightTriangle, msoLanguageIDMaltese,
    msoLanguageIDSpanishBolivia, msoThreeD10,
    msoLanguageIDQuechuaPeru, xlDoughnut, msoPresetCameraMixed,
    xl3DPieExploded, ThreeDFormat, msoEncodingTaiwanEten,
    msoTargetBrowserIE4, xlCross, msoElementUpDownBarsShow,
    msoEncodingMacRoman, msoGradientDiagonalUp, msoShape32pointStar,
    msoShapePentagon, msoSyncStatusNotRoaming, msoTextEffect37,
    msoEffectSaturation, msoWebVideo, msoShapeBentArrow, msoIconTip,
    msoTabAlignMixed, msoBackgroundStylePreset11, msoCharWrapMixed,
    msoShapeCurvedUpRibbon, msoPatternWave, msoCalloutAngle45, xlNone,
    msoShapeActionButtonEnd, msoCameraPerspectiveFront,
    msoLineStylePreset5, msoBulletThaiAlphaParenRight, msoLineDashDot,
    msoStrikeMixed, msoCameraLegacyObliqueBottom,
    msoFileFindSortbyAuthor, msoCalloutMixed,
    ...
    xlChartArea, msoSignatureSubsetSignatureLines, msoLineSquareDot,
    msoShapeSquareTabs, msoTextureTypeMixed, msoPatternLargeGrid,
    CommandBar, msoSendBackward, msoColorTypeScheme,
    msoAnimationGestureDown, msoElementErrorBarPercentage,
    xlBarStacked100Ex, ILicValidator,
    ...
    msoConditionNotEqualToLow, msoLineDash, msoBulletArabicAbjadDash,
    msoPictureCompressDocDefault, xlLineStacked100Ex,
    msoGradientWheat, msoLineStylePreset30,
    msoCameraObliqueBottomRight, msoShapeLineCallout3NoBorder,
    msoPatternDashedUpwardDiagonal, msoPattern10Percent,
    msoElementLineDropHiLoLine, DISPMETHOD, msoLineStylePreset21,
    ...
    msoExtrusionTop, msoCapsMixed, msoShapeStylePreset69, msoBarRight,
    msoShapeMixed, ShapeNode, msoElementSecondaryValueGridLinesMinor,
    msoShapeStylePreset39, msoColorTypeCMYK,
    msoBackgroundStylePreset8, EffectParameters,
    ...
    msoGroup, msoConditionLessThan, msoShapeLineCallout1,
    msoUnderlineDottedLine, msoThemeColorDark1, msoPattern40Percent,
    msoAnchorMiddle, msoElementSecondaryValueAxisNone, msoConditionOn,
    msoBlackWhiteBlack, msoEncodingHZGBSimplifiedChinese,
    CustomTaskPane, msoLanguageIDChineseHongKong, msoMergeFragment,
    msoEffectTexturizer, msoShapeRightBracket,
    msoEncodingISO88592CentralEurope,
    msoConditionNotEqualToNotStarted, msoShapeHeart,
    msoTextEffectShapeFadeUp, msoBringForward, msoTextureWhiteMarble,
    xlHAlignCenterAcrossSelection, msoLanguageIDInstall, xlOutside,
    ...
    msoControlSplitButtonMRUPopup, xlDisplayUnitLabel, MetaProperties,
    xlChartElementPositionCustom, msoElementDataLabelOutSideEnd,
    msoEncodingISCIIMalayalam, msoWarpFormat24, msoWarpFormat22,
    msoControlGraphicPopup, xlLabelPositionCustom, SensitivityLabel,
    msoShapeActionButtonSound, msoLanguageIDUIPrevious, msoShadow14,
    msoTextEffectShapeArchUpPour, msoTextBox,
    msoBalloonErrorBadCharacter, msoCharacterSetKorean, xlCylinderCol,
    msoMaterialDarkEdge, msoConditionFileTypeContactItem,
    ...
    msoEncodingEBCDICSerbianBulgarian, msoLightRigSunrise, IMsoSeries,
    msoLanguageIDWelsh, msoUnderlineDashLongHeavyLine,
    msoLineJoinRound, msoAnimationWorkingAtSomething,
    msoShape12pointStar, msoTextEffectShapeDeflateInflateDeflate,
    msoShapeStylePreset32, msoDateTimeMMddyyHmm,
    xlLabelPositionBestFit, msoConnectorOr, msoNewfromTemplate,
    msoTextEffectShapeSlantUp, msoEncodingEBCDICUnitedKingdom,
    msoEncodingKOI8U, msoCameraIsometricTopUp, msoFillGradient,
    msoColorTypeCMS, msoLanguageIDKanuri,
    xlGradientStopPositionTypeNumber, msoTextureMediumWood,
    msoGradientSapphire, msoCameraIsometricOffAxis1Right,
    msoDateTimeMMyy, msoReflectionType5, msoElementLineNone,
    msoPropertyTypeBoolean, FileDialogSelectedItems, msoShapeCorner,
    msoLanguageIDGerman, msoGraphicStylePreset6, msoAlignLefts,
    msoTextEffect44, msoThemeColorAccent2, msoCharacterSetJapanese,
    msoGraphicStylePreset10, xlBelow, msoShadow18, xlHiLoLines,
    msoBackgroundStylePreset1, Ruler2, msoPermissionFullControl,
    msoLanguageIDIgbo, msoLineJoinMixed, msoShapeStylePreset31,
    FileDialog, msoEncodingEBCDICJapaneseLatinExtendedAndJapanese,
    msoCameraPerspectiveAbove, msoHyperlinkRange, xlLine,
    msoPatternLargeCheckerBoard, msoEffectCement, msoTextEffect16,
    PickerField, msoBarTop, msoEffectPhotocopy, msoIconAlertCritical,
    xlDays, msoShapeLineCallout3AccentBar, msoShapeStylePreset68,
    IMsoCorners, msoLanguageIDRussianMoldova, msoGradientDiagonalDown,
    _IMsoDispObj, msoEncodingMacCyrillic, CategoryCollection,
    IMsoInterior, BalloonCheckbox, xlSuggestedChart,
    ...
    msoTelemetryConsentLevelBasic, msoIodGroupVSTOR40Mgd, xlSolid,
    certverresInvalid, msoTextEffectShapeChevronUp, xlLinear,
    msoEncodingISCIIKannada, msoTelemetryConsentLevelDefault,
    msoShapeStylePreset20, msoModeModeless,
    msoLanguageIDEnglishCaribbean, msoShadow30, msoLineFillGradient,
    ...
    msoEncodingKoreanAutoDetect, sigprovdetUseOfficeUI, NoBroadcast,
    msoIconAlertQuery, msoShadow23,
    msoElementPrimaryCategoryGridLinesMajor,
    msoEncodingEBCDICGreekModern, msoAnimationGetWizardy,
    typelib_path, msoBalloonErrorButtonModeless, msoConditionLastWeek,
    msoCustomXMLNodeComment, msoLanguageIDPortuguese,
    xlGeoProjectionTypeRobinson, xlScaleLinear, msoEncodingCyrillic,
    msoMergeUnion, xlLabelPositionRight,
    msoElementSeriesAxisTitleHorizontal, msoLightRigFlat,
    msoEffectGlowDiffused, ICTPFactory, xlGray50, COMAddIns,
    xlDownward, msoEncodingEBCDICTurkish, msoConditionEqualsDeferred,
    msoShapeActionButtonDocument, xlCylinderColClustered,
    msoPathTypeNone, msoLineStylePreset24, IMsoTrendline,
    msoLineStylePreset15, SeriesGradientStopData,
    msoGraphicStylePreset22, xlColumnClustered, msoLineDashDotDot,
    contverresError, msoPresetLightingSoftnessMixed,
    xlCylinderBarStacked100, msoCustomCharWrap,
    msoShapeLineCallout2AccentBar, msoConditionTomorrow,
    xlSeriesColorGradientStyleDiverging, msoShapeCross, BSTR,
    msoReflectionTypeMixed, msoEncodingEBCDICJapaneseKatakanaExtended,
    msoEncodingEUCJapanese, msoConditionFileTypeMailItem,
    msoDateTimedMMMyy, xlCylinderBarClustered, msoSoftEdgeType1,
    xlXYScatterLines, msoLanguageIDKirghiz, msoBevelNone,
    msoBevelAngle, xlTickMarkInside, msoShapeCloudCallout,
    msoShapeUpRibbon, xlVAlignDistributed, CommandBarButton,
    msoShapeRound2DiagRectangle, msoAutoSizeShapeToFitText,
    msoGradientSilver, msoShapeGear6, msoLineThinThin, msoOptionsAdd,
    msoLanguageIDSpanishPuertoRico, msoCameraIsometricBottomUp,
    msoLanguageIDDanish, xlUnderlineStyleDoubleAccounting,
    sigtypeUnknown, msoLineCapFlat, sigdetIPCurrentView,
    msoBarNoHorizontalDock, msoArrowheadShort, msoLanguageIDKazakh,
    msoLanguageIDEnglishPhilippines, msoMergeSubtract,
    msoWarpFormat34, msoChartFieldPercentage, msoLightRigLegacyHarsh1,
    msoBulletRomanLCPeriod, xl3DColumnStacked100, xlSurfaceTopView,
    sigtypeNonVisible, msoClipboardFormatHTML,
    msoCTPDockPositionRestrictNone, msoSignatureSubsetAll, xlGeneral,
    msoMenuAnimationNone, msoWarpFormat17,
    xlParentDataLabelOptionsNone, msoCameraIsometricOffAxis3Left,
    msoShapeStylePreset34, DiagramNodes, msoShapeRightArrow, xlRows,
    msoLineStylePreset11, msoEditingCorner, msoAlertIconQuery,
    IMsoHiLoLines, ChartFont, Scripts, xlErrorBarIncludeBoth,
    msoButtonSetNextClose, msoElementPrimaryValueAxisThousands,
    msoAnimationLookLeft, msoBackgroundStylePreset2, msoBarRowLast,
    ...
    CalloutFormat, xlShape, msoElementSecondaryCategoryAxisBillions,
    msoPropertyTypeNumber, msoElementPrimaryCategoryAxisThousands,
    _midlSAFEARRAY, msoEncodingWestern, msoEncodingOEMCyrillicII,
    msoBarTypeNormal, msoTextEffectShapeArchUpCurve,
    msoScriptLanguageJava, msoLanguageIDOromo, msoWarpFormat23,
    msoCaseToggle, msoEffectBackgroundRemoval, msoShapeLightningBolt,
    msoEffectWatercolorSponge, msoAnimationLookDownRight,
    msoCharacterSetMultilingualUnicode, msoFileTypeDatabases,
    msoGraphicStyleNotAPreset, msoThreeD17,
    msoShapeLineCallout2NoBorder, msoCalloutOne,
    msoCameraPerspectiveContrastingRightFacing, msoLineStylePreset18,
    msoLanguageIDRomanianMoldova, msoScriptAnchor,
    msoLanguageIDEnglishNewZealand, msoArrowheadLengthMedium,
    msoSyncEventDownloadSucceeded, CustomTaskPaneEvents,
    msoShapeOvalCallout, msoDateTimeFigureOut,
    msoEffectColorTemperature, msoElementSecondaryValueAxisTitleNone,
    msoGraphicStylePreset7, msoControlDropdown, msoDateTimehmmssAMPM,
    xlStError, msoArrowheadOval, msoLanguageIDPunjabi,
    msoCTPDockPositionRight, msoAnimationGestureUp,
    msoLanguageIDAssamese, msoThemeColorAccent6, msoLanguageIDFarsi,
    msoUnderlineDashHeavyLine, msoConditionFileTypeVisioFiles,
    msoThemeLight1, xlErrorBarIncludePlusValues,
    msoMsoTextRangeInsertAfter, xlRegionMap, xlMajorGridlines,
    msoControlActiveX, msoConditionFileTypeTemplates,
    msoAnimationSaving, msoPermissionExtract, msoDoubleStrike,
    xlCategoryDescending, ChartColorFormat, msoViewPreview,
    msoEncodingISCIIDevanagari,
    msoElementSecondaryValueGridLinesMajor, msoShadow42,
    msoElementDataTableWithLegendKeys, msoCalloutTwo, msoFlipVertical,
    msoSyncEventUploadInitiated, msoReflectionType8, msoTabStopCenter,
    msoLanguageIDArabicLebanon, msoLineStylePreset22, msoThreeD9,
    msoLineStylePreset2, xlDataLabelsShowBubbleSizes,
    msoEncodingMacLatin2, msoConditionFileTypePublisherFiles,
    ...
    msoLanguageIDSepedi, msoShapeFlowchartManualOperation,
    xlBubble3DEffect, msoSyncErrorCouldNotOpen,
    msoShapeVerticalScroll, msoSoftEdgeTypeNone, msoUnderlineWords,
    msoFileTypeMailItem, msoCustomXMLNodeDocument, Points,
    WebComponent, msoChartFieldValue, BalloonCheckboxes,
    msoCameraPerspectiveContrastingLeftFacing, msoSearchInCustom,
    msoThemeFollowedHyperlink, msoAnchorNone, msoShapeStylePreset43,
    xlContext, msoShapeStylePreset28, xlBoth, msoPathType3,
    msoSyncStatusLatest, xlLightDown, msoEffectCrisscrossEtching,
    msoLanguageIDArabicYemen, msoLanguageIDSpanishArgentina,
    xlErrorBarTypeFixedValue, msoBalloonTypeBullets, msoCaseTitle,
    msoPatternWeave, msoDiagram, msoArrowheadNarrow,
    msoArrowheadStealth, xl3DLine, ThemeColorScheme,
    msoLineFillTextured, msoLanguageIDGuarani, msoButtonWrapText,
    EncryptionProvider, msoLineThickBetweenThin,
    msoLanguageIDSanskrit, xlLabelPositionOutsideEnd, msoShadow25,
    WorkflowTemplates, msoOrgChartLayoutStandard,
    msoControlSplitButtonPopup, msoGradientColorMixed,
    BroadcastCapSupportsMeetingNotes, msoTextEffect25,
    msoLightRigLegacyFlat2, msoButtonSetBackNextClose, xlSplitByValue,
    xlTenMillions, msoElementTrendlineAddLinearForecast,
    msoAlertButtonOK, msoEffectChalkSketch, xlPlusValues,
    msoAlignRight, msoFontAlignBaseline, msoPermissionSave,
    msoWarpFormat7, msoEncodingMacGreek1, msoBarPopup,
    msoTextOrientationHorizontal, xlHAlignLeft,
    msoShapeCurvedDownRibbon, msoTextEffectAlignmentLeft,
    msoTextureRecycledPaper, msoBarTypeMenuBar, ThemeEffectScheme,
    msoSignatureSubsetSignaturesNonVisible, msoConditionEqualsNormal,
    msoElementDataLabelBottom, msoElementSeriesAxisTitleRotated,
    xlInside, msoLanguageIDSorbian, msoEncodingISO88598Hebrew,
    ...
    msoThemeHyperlink, msoLineStylePreset4, xlBarStackedEx,
    msoCTPDockPositionRestrictNoVertical, msoGradientMahogany,
    SharedWorkspaceFiles, msoShapeActionButtonReturn,
    msoEncodingOEMCyrillic, IRibbonUI, msoLanguageIDFrenchMonaco,
    ...
    msoBalloonTypeButtons, msoBalloonErrorTooBig,
    msoContactCardAddressTypeOutlook, msoOrgChartLayoutRightHanging,
    msoElementPlotAreaNone, MsoFarEastLineBreakLanguageJapanese,
    IBlogPictureExtensibility, msoTextureWovenMat,
    msoShapeFlowchartDisplay, SeriesGradientStopColorFormat,
    msoAlertButtonYesNoCancel, msoLanguageIDMongolian,
    msoSharedWorkspaceTaskPriorityLow, xlFixedValue,
    msoCTPDockPositionRestrictNoHorizontal,
    msoLanguageIDEnglishIreland, msoLanguageIDSpanishChile,
    msoBeforeFirstSibling, msoWarpFormat18, msoLinkedOLEObject,
    msoEncodingUnicodeBigEndian, msoShapeStylePreset24,
    msoTextEffectShapeArchDownPour, xlLow, msoLanguageIDNone,
    IMsoDataLabels, msoLanguageIDSpanishGuatemala, SmartArtColors,
    msoTextEffect39, msoGradientFire,
    msoTextOrientationHorizontalRotatedFarEast, msoMaterialPlastic,
    msoLightRigMixed, msoShapeStylePreset21, xlThin,
    msoAnimationGetTechy, msoScreenSize1024x768, msoShapeDoubleWave,
    msoMetaPropertyTypeInteger, msoBlackWhiteGrayOutline,
    msoLanguageIDKorean, msoLanguageIDGreek, sigdetDelSuggSignerEmail,
    ...
    msoLanguageIDLatin, ParagraphFormat2, msoLightRigLegacyHarsh3,
    msoPictureBlackAndWhite, msoElementDataLabelShow,
    ...
    msoCameraIsometricOffAxis4Left, xlOuterClockwisePoint, xlPrimary,
    xlRadarFilled, cipherModeCBC,
    msoElementPrimaryValueAxisTitleAdjacentToAxis, xlIndexDescending,
    msoLanguageIDUrdu, msoReflectionType3,
    msoTextEffectShapeRingInside, msoAnimationLookUpLeft,
    msoBevelSoftRound, ConnectorFormat, msoAutoSizeTextToFitShape,
    msoAnchorBottomBaseLine, msoReflectionType4, msoPattern30Percent,
    ...
    msoMsoTextRangeInsertBefore, msoEncodingISO6937NonSpacingAccent,
    msoBevelRelaxedInset, msoLanguageIDTigrignaEthiopic,
    msoUnderlineDashLongLine, xlTickLabelPositionNextToAxis,
    msoBaselineAlignCenter, xlTickLabelPositionHigh, BalloonLabel,
    msoPictureTypePDF, msoWarpFormat27, msoButtonIcon,
    msoContactCardAddressTypeIM, msoLineLongDashDot, xlSizeIsArea,
    msoLanguageIDHawaiian, msoElementPrimaryValueAxisNone,
    msoConditionEqualsHigh, msoBulletPicture, msoControlComboBox,
    msoScreenSize640x480, ILicWizExternal, msoCameraObliqueBottom,
    msoLanguageIDChineseHongKongSAR, msoMetaPropertyTypeUserMulti,
    ...
    msoEncodingOEMModernGreek, msoShapeFlowchartManualInput, STANDARD,
    msoFileDialogViewLargeIcons, msoAnimationPrinting,
    msoMetaPropertyTypeUnknown, msoShapeFunnel, xlDataLabelsShowValue,
    msoHTMLProjectStateProjectLocked, xlVerticalCoordinate,
    msoLanguageIDTamil, msoWarpFormat21, msoShadow31, msoWarpFormat6,
    ...
    msoPatternDiagonalCross, msoFileDialogFilePicker,
    _CommandBarButton,
    msoElementPrimaryCategoryAxisTitleAdjacentToAxis, xlColumnField,
    msoFileTypeWordDocuments,
    msoEncodingEBCDICUSCanadaAndTraditionalChinese, msoMaterialMatte,
    msoShapeFlowchartConnector, Trendlines, HTMLProjectItems,
    SeriesCollection, SmartArt, sigdetNumberOfMonitors,
    msoShapeChartStar, xlThick, msoWarpFormat5, msoLanguageIDVenda,
    msoElementDataLabelBestFit, msoTextEffectShapeInflateBottom,
    msoElementSecondaryCategoryAxisTitleRotated, msoSyncErrorUnknown,
    msoCharacterSetVietnamese, msoEncodingKoreanJohab, LegendEntry,
    msoTextEffect18, msoAnimationListensToComputer,
    msoBalloonErrorOther, msoTextEffect21, msoEncodingISCIITamil,
    msoEncodingEBCDICArabic, msoTextEffectShapeCirclePour,
    xlAxisCrossesMinimum, msoDownloadContentEnabled,
    msoElementChartWallNone, msoMaterialMetal, msoDiagramVenn,
    msoElementLegendNone, msoShapeCurvedRightArrow,
    msoElementDataLabelInsideEnd, msoLineStylePreset1,
    msoTextEffect27, xlDiamond,
    msoLanguageIDBosnianBosniaHerzegovinaLatin, xlShowValue,
    msoPickerFieldUser, xlMidClockwiseRadiusPoint, ContactCard,
    msoSoftEdgeType6, msoFileTypeNoteItem, msoButtonSetYesAllNoCancel,
    msoCreateNewFile, msoTriStateToggle, msoShadow11,
    sigdetVertResolution,
    msoElementSecondaryCategoryAxisTitleBelowAxis,
    msoCustomXMLNodeElement, msoLanguageIDEnglishCanadian, xlNothing,
    Shapes, msoSmartArtNodeBelow, msoLanguageIDEstonian,
    msoLanguageIDSindhi, msoHorizontalAnchorMixed, msoLineSingle,
    msoSoftEdgeType3, msoLineStylePreset28, SignatureSetup,
    ChartPoint, msoFileValidationSkip,
    msoElementPrimaryValueGridLinesMinor, msoButtonSetYesNoCancel,
    _CommandBars, msoPathType4, msoTextEffect7,
    ...
    msoSyncErrorCouldNotConnect, msoAlignJustifyLow, msoWarpFormat16,
    msoThemeColorBackground2, MsoDebugOptions_UTManager,
    msoEncodingEBCDICGermany, msoOLEMenuGroupHelp,
    msoShapeStylePreset61, msoBarMenuBar, msoReflectionType1,
    msoAutoSizeMixed, msoWizardMsgLocalStateOn,
    msoEncodingISCIITelugu, sigdetOfficeVersion, msoOptionsNew,
    msoLightingTopRight, msoGraphicStylePreset14, msoButtonSetYesNo,
    msoBalloonErrorOutOfMemory, msoThemeAccent2,
    msoSharedWorkspaceTaskPriorityNormal, msoShapeActionButtonCustom,
    msoLanguageIDMexicanSpanish, msoShadow5, msoShapeStylePreset46,
    msoAlignDistribute, msoLanguageIDGaelicScotland,
    msoTextEffectShapeCurveDown, msoWarpFormat2,
    msoElementUpDownBarsNone, msoWarpFormat14, msoBulletStyleMixed,
    msoEncodingISO2022CNTraditionalChinese, msoSortByFileType,
    msoWarpFormat36, msoPropertyTypeDate, msoLanguageIDSamiLappish,
    xlStockVOHLC, TextRange2, msoElementPrimaryCategoryGridLinesMinor,
    msoFileDialogViewProperties, msoConditionDoesNotEqual,
    msoMaterialMetal2, msoThreeD5, msoTextEffect43,
    sigdetDelSuggSignerLine2, msoShapeFlowchartStoredData,
    ISensitivityLabelEvents, msoPatternLightDownwardDiagonal,
    msoTextureParchment, ColorFormat, msoArrowheadStyleMixed,
    msoEncodingMacTurkish, COMMETHOD, msoLanguageIDNorwegianNynorsk,
    msoShapeArc, msoInkComment, TabStop2,
    msoConditionFileTypeDocumentImagingFiles, msoLanguageIDBengali,
    msoShapeStylePreset77, msoAnimationSendingMail, msoShapeCube,
    msoShapeTear, xlBarStacked100, msoThemeAccent3, xlDataTable,
    msoButtonMixed, CustomXMLValidationError, msoShapeUpArrowCallout,
    msoWizardActActive, msoLineThinThick, encprovdetUrl, xlShowLabel,
    msoShapeLeftRightCircularArrow, msoPatternLightHorizontal,
    msoLanguageIDTamazight, msoShape8pointStar, xlIndexAscending,
    msoExtrusionBottom, msoLanguageIDFrenchWestIndies, Font2,
    msoLanguageIDRhaetoRomanic, msoCameraPerspectiveHeroicRightFacing,
    msoGradientLateSunset, msoCTPDockPositionLeft,
    msoLineLongDashDotDot, msoClipboardFormatRTF, ThemeColor,
    sigtypeSignatureLine, TextFrame2, msoDateTimeddddMMMMddyyyy,
    xl3DBar, msoEffectCutout, msoSyncAvailableNone, xl3DAreaStacked,
    msoCameraLegacyObliqueBottomLeft, msoEncodingEBCDICThai,
    msoShapeStylePreset54, msoBulletAlphaLCParenRight,
    msoGraphicStylePreset18, msoLineStylePreset39, xlConeToPoint,
    xlValueAscending, msoCalloutDropTop, xlPyramidBarStacked100,
    xl3DColumnStacked, CustomXMLParts, msoWizardActSuspend, xlGray75,
    ...
    msoUserContentEnabled, msoShapeCurvedUpArrow, msoDiagramOrgChart,
    msoTabStopRight, msoShapePlaqueTabs, msoShapeStylePreset29,
    msoAllCaps, msoCustomXMLNodeProcessingInstruction,
    msoBulletSimpChinPlain, xlConeBarStacked, msoLightRigChilly,
    msoLanguageIDSlovak, msoCalloutDropMixed, msoFillTextured,
    SearchScopes, msoCanvas, msoLineSysDot,
    msoCameraLegacyPerspectiveLeft, msoShapeFlowchartOr,
    MsoFarEastLineBreakLanguageKorean, msoElementLegendLeft,
    msoGraphicStylePreset17, CommandBarPopup,
    msoConditionFileTypeJournalItem, DiagramNode, msoMaterialFlat,
    msoCameraPerspectiveAboveLeftFacing, msoGraphicStylePreset5,
    msoSendBehindText, msoAnchorTop, msoEncodingISCIIOriya,
    msoPictureWatermark, msoGradientCalmWater, msoOptionsWithin,
    msoGraphicStylePreset24, msoWarpFormat25,
    msoMetaPropertyTypeComputed, msoEncodingEBCDICIcelandic,
    msoFilterComparisonNotContains, msoConditionEqualsNotStarted,
    msoLanguageIDLao, xlCylinderBarStacked, xlHairline,
    msoEncodingEBCDICMultilingualROECELatin2, xlAxisCrossesMaximum,
    xlMonths, msoDateTimedMMMMyyyy, msoSyncEventDownloadNoChange,
    msoEncodingTaiwanTeleText, msoShapeStylePreset42, xlCustom,
    msoLightingBottom, msoSearchInOutlook, msoLineStylePreset42,
    ...
    msoBevelHardEdge, msoBulletTradChinPlain, msoAnimationGetArtsy,
    msoLanguageIDArabicLibya, msoLightRigFreezing,
    msoEncodingEUCTaiwaneseTraditionalChinese, msoLineStylePreset23,
    msoScaleFromMiddle, xlGeoProjectionTypeAutomatic,
    msoShapeStylePreset15, msoLanguageIDSpanish, mfRTF, IMsoCategory,
    xlGeoMappingLevelDataOnly, msoBulletThaiNumPeriod,
    msoFileTypeDocumentImagingFiles, msoGradientChromeII,
    msoLanguageIDUkrainian, msoLightRigLegacyNormal4, msoBevelCircle,
    msoShapeLineCallout1NoBorder, ChartFillFormat, msoCalloutAngle30,
    msoTextOrientationDownward, msoShadow37, msoDateTimeMMMMdyyyy,
    msoPattern50Percent, Adjustments, msoDiagramNode,
    msoFileTypeContactItem, msoLanguageIDSpanishNicaragua,
    msoShapeMathDivide, msoLanguageIDBosnian, msoBulletNumbered,
    msoLineStylePreset40, msoScreenSize544x376,
    msoCharacterSetEnglishWesternEuropeanOtherLatinScript,
    msoDateTimeFormatMixed, certdetThumbprint, msoPatternSmallGrid,
    ...
    msoWarpFormat19, msoAnimationDisappear, msoLanguageIDFilipino,
    xlTickMarkNone, msoBlackWhiteGrayScale, msoFileTypePhotoDrawFiles,
    ...
    cipherModeECB, msoThreeD3, msoSyncAvailableOffline,
    msoblogImageTypePNG, msoControlButtonPopup,
    msoPickerFieldDateTime, msoElementPrimaryCategoryAxisReverse,
    msoTextureTopRight, msoBulletArabicAlphaDash,
    msoLanguageIDEnglishUK, msoContactCardTypeEnterpriseGroup,
    msoLineStylePreset12, msoFillPicture, msoShapeSnip2DiagRectangle,
    msoLastModifiedToday, msoLastModifiedYesterday, DocumentInspector,
    xlHAlignCenter, msoShapeFlowchartInternalStorage,
    msoTextureBottomLeft, msoEncodingArabicTransparentASMO,
    RibbonControlSizeRegular, msoSyncErrorUnauthorizedUser,
    msoLanguageIDVietnamese, msoShapeLeftRightUpArrow,
    msoEffectPaintBrush, msoMenuAnimationUnfold,
    msoEncodingOEMTurkish, GUID, xlCategoryAscending,
    msoDiagramPyramid, msoTelemetryConsentLevelUnset, IMsoDataTable,
    msoShapeLeftRightArrow, msoSortByFileName, msoCharacterSetArabic,
    msoElementPrimaryCategoryAxisNone, msoEncodingTaiwanTCA,
    msoEncodingEBCDICGreek, msoElementDataLabelInsideBase,
    msoShapeActionButtonInformation, IRibbonControl, msoButtonSetOK,
    msoElementPrimaryCategoryAxisTitleVertical, xl3DArea,
    msoGraphicStylePreset2, msoWarpFormat20, msoElementDataLabelLeft,
    msoEncodingTraditionalChineseBig5, msoGradientFromCenter,
    msoShapeStylePreset6, msoPresetExtrusionDirectionMixed,
    msoSortByNone, msoTextEffectShapeDoubleWave1, AnswerWizard,
    msoShadow41, msoConnectorAnd, xlGeoMappingLevelCounty,
    msoTextOrientationVertical, msoBalloonErrorBadReference,
    msoPermissionObjModel, xlUnderlineStyleNone, msoConditionAtMost,
    msoBarNoCustomize, msoShadow21, msoCalloutDropBottom,
    msoAnimationAppear, msoOrientationVertical,
    msoFileDialogViewThumbnail, msoButtonSetRetryCancel,
    xlLineMarkersStacked100, msoLanguageIDSpanishModernSort,
    msoTextEffect41, msoSingleMixed, msoShapePie, msoTargetBrowserIE6,
    xlExponential, msoLanguageIDOriya, msoButtonWrapCaption,
    msoControlWorkPane, xlTop, SharedWorkspaceFolder,
    msoLanguageIDFinnish, msoBackgroundStylePreset7,
    msoConditionNotEqualToInProgress, msoClipboardFormatNative,
    msoShapeStylePreset59, msoShadow20, IMsoAxis, xlMarkerStyleSquare,
    ...
    msoShapeMathEqual, msoCameraLegacyPerspectiveBottomRight,
    msoShapeNoSymbol, msoShapeUpArrow, msoShapeStylePreset12,
    msoAnimationGetAttentionMinor,
    msoElementPrimaryValueAxisTitleHorizontal, msoLineStylePreset31,
    msoConditionFileTypeProjectFiles, msoLanguageIDSwissItalian,
    msoShapeHorizontalScroll, msoLanguageIDEnglishZimbabwe,
    xlTimeScale, xlGeoProjectionTypeMercator,
    msoShapeFlowchartMultidocument, msoShapeStylePreset45,
    msoLineStylePreset6, msoWarpFormat13, offPropertyTypeBoolean,
    msoShapePlaque, msoLanguageIDFrenchCotedIvoire,
    msoLineStylePreset26, msoTabStopDecimal, msoConnectorTypeMixed,
    msoMaterialMatte2, IRibbonExtensibility, msoIconAlert,
    msoGradientGold, msoCaseUpper, msoShapeExplosion2,
    ...
    msoLanguageIDFrenchHaiti, msoConnectorStraight, msoMethodGet,
    msoMoveRowNext, IMsoChart, VARIANT_BOOL, xlChartX, Axes,
    IMsoDropLines, msoShadow38, ScopeFolders, IMsoDataLabel,
    xlChecker, msoTextEffect15, xlTickLabelOrientationUpward,
    msoTextEffectShapeFadeRight, msoBarNoProtection,
    msoThemeColorAccent5, WorkflowTasks, xlPyramidToPoint,
    msoBlackWhiteDontShow, msoEncodingOEMHebrew, xlMovingAvg,
    ShapeNodes, msoEncodingMacJapanese, msoTextEffect19, SearchScope,
    msoElementPrimaryValueGridLinesMinorMajor, msoShapeTrapezoid,
    msoShapeStylePreset17, msoTextEffect48, msoShapeStylePreset44,
    msoShapeCornerTabs, msoTextEffect30,
    msoCameraIsometricOffAxis4Bottom, msoMoveRowNbr,
    msoEncodingAutoDetect, msoPattern20Percent,
    msoEncodingISCIIGujarati, ICustomTaskPaneConsumer,
    xlTickLabelOrientationHorizontal, xlErrorBarIncludeMinusValues,
    msoTextEffect1, msoElementPrimaryValueGridLinesMajor,
    msoBulletArabicPlain, msoTextEffectShapeTriangleDown, xlSurface,
    msoShadow15, msoElementSeriesAxisShow, msoOpenDocument, xlGrid,
    ...
    msoOLEMenuGroupContainer, MsoRGBType, msoFileDialogViewWebView,
    ...
    msoLanguageIDSpanishPeru, xlHAlignGeneral, msoGradientHorizon,
    xlRight, msoEffectFilmGrain, msoFileFindSortbyDateSaved,
    msoPatternDarkHorizontal, msoSmartArt, msoShapeStylePreset3,
    xlBinsTypeBinSize, IMsoChartFormat, msoShapeUpDownArrowCallout,
    msoConditionFileTypeBinders, FillFormat, msoShapeStylePreset13,
    xlGeoMappingLevelPostalCode, xlLogarithmic, msoNoCharWrap,
    msoEncodingTaiwanCNS, xl3DBarStacked100, msoShadow43,
    msoBulletCircleNumWDBlackPlain, msoLanguageIDGermanLiechtenstein,
    msoLanguageIDAzeriCyrillic, xlStackScale, xlArea, msoControlGauge,
    msoAnimationLookDown, msoHTMLProjectOpenTextView, msoTextureRight,
    msoElementSecondaryCategoryAxisMillions, msoSoftEdgeType5,
    msoTextEffectShapeCanDown, msoTextEffectShapeCascadeUp,
    msoThemeComplexScript, msoPresetThreeDFormatMixed
)
